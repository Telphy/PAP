...
CREATE TABLE `historico` (
  ...
  KEY `fk_Historico_Intervencoes1_idx` (`idIntervencao`),
  CONSTRAINT `fk_Historico_Intervencoes1` FOREIGN KEY (`idIntervencao`) REFERENCES `intervencoes` (`idIntervencao`) ON DELETE NO ACTION ON UPDATE NO ACTION
