...
CREATE TABLE `viaturas` (
  ...
  KEY `fk_Viaturas_Clientes_idx` (`idCliente`),
  CONSTRAINT `fk_Viaturas_Clientes` FOREIGN KEY (`idCliente`) REFERENCES `clientes` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `viaturas` VALUES (111111,1,'Ford','Fiesta','Cinza');
